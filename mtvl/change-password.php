...
<div class="body2">
  <div class="main">
    <section id="content">
      <div class="marg_top wrapper">
        <div class="box1_out">
          <div class="box1">
            <h2 class="desc">Change Password</h2><br>
  ...
  <tr>
    <td width="25%" align="right" valign="middle">Current Password: &nbsp;&nbsp;</td>
    <td width="75%" align="left" valign="middle"><input type="password" name="cpass" class="input"></td>
  </tr>
  <tr>
    <td align="right" valign="middle">New Password: &nbsp;&nbsp;</td>
    <td align="left" valign="middle"><input type="password" name="npass" class="input"></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Confirm New Password: &nbsp;&nbsp;</td>
    <td align="left" valign="middle"><input type="password" name="cnpass" class="input"></td>
  </tr>
  <tr>

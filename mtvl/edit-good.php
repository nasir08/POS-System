...
<div class="body2">
  <div class="main">
    <section id="content">
      <div class="marg_top wrapper">
        <div class="box1_out">
          <div class="box1">
            <h2 class="desc">Edit Item Details</h2>
  ...
  <tr>
    ...
    <td width="86%" align="left" valign="middle"><input type="text" name="name" class="input" style="width:300px;" value="<?php echo $row['item_name'] ?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Family: &nbsp;&nbsp;</td>
    <td align="left" valign="middle"><input type="text" name="family" class="input" style="width:300px;" value="<?php echo $row['family'] ?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Price: &nbsp;&nbsp;</td>
    <td align="left" valign="middle"><input type="text" name="price" class="input" style="width:300px;" value="<?php echo $row['unit_price'] ?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Inventory: &nbsp;&nbsp;</td>
    <td align="left" valign="middle"><input type="text" name="inv" class="input" style="width:300px;" value="<?php echo $row['amount_rem'] ?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Delimeter: &nbsp;&nbsp;</td>
    <td align="left" valign="middle"><input type="text" name="del" class="input" style="width:300px;" value="<?php echo $row['delimeter'] ?>"></td>
  </tr>
  <tr>

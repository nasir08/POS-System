...
<?php
	...
	if($_SESSION['id']==6)
	{
		echo"<input type=checkbox name=reveal value=1>";
	}
?>
...
if($error=="no")
	...
	mysql_query("INSERT INTO reciept (name,amount,amount_paid,vat,`change`,r_change,sales_point,date,remark,type,balance,rev) VALUES ('$name','$total','$amount_paid','$vat','$change','$change','$sp','$today','$remark','$type','$balance','$reveal')");

		...
		<div id="main">
			<div class="full_w">
            		...
            		if(isset($_POST['login']))
    				{
						...
						else
						{
        					...
        					if($row>0)
        					{
								...
								if($row['status']==1)
								{ echo"<center><b class=loginError>Account blocked, contact Admin for assistance.</b></center><br />"; }
								else
								{
   	        					Redirect('sales.php');
								}
				...
				?>
					...
					<input id="login" name="username" class="text" autofocus="autofocus" value=<?php if(isset($_POST['login'])){ echo $username; } ?> >
